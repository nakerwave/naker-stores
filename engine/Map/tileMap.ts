...
export class TileMap {
    ...
    constructor(system: MeshSystem, Ground: Ground) {
        this.system = system;
        this.Ground = Ground;
    ...
    createPlayer(starInterface: StarInterface) {
        let player = new Player(this.system, this.Ground, starInterface);
    ...
    createBlackHole(position: Vector2) {
        let blackHole = new BlackHole(this.system, this.Ground, position);
